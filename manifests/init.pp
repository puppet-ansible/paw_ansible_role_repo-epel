...
class paw_ansible_role_repo_epel (
  String $epel_repo_url = 'https://dl.fedoraproject.org/pub/epel/epel-release-latest-{{ ansible_distribution_major_version }}.noarch.rpm',
  String $epel_repo_gpg_key_url = 'https://dl.fedoraproject.org/pub/epel/RPM-GPG-KEY-EPEL-{{ ansible_distribution_major_version }}',
...
# Execute the Ansible role using PAR (Puppet Ansible Runner)
  ...
  $playbook_path = "${vardir}/lib/puppet_x/ansible_modules/ansible_role_repo_epel/playbook.yml"
